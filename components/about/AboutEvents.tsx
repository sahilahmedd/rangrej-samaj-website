      ...
      <div className="container px-4 md:px-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          {/* <TabsContent value="introduction">
            <h2 className="text-2xl font-bold mb-4">Introduction to Rangraj Samaj</h2>
            <p>The Rangraj (Rangrez) Samaj is a vibrant community...</p>
          </TabsContent>

          <TabsContent value="history">
            <h2 className="text-2xl font-bold mb-4">Our Rich History</h2>
            <p>The Rangraj community has a history dating back...</p>
          </TabsContent>

          <TabsContent value="mission">
            <h2 className="text-2xl font-bold mb-4">Our Mission & Vision</h2>
            <p>To empower the Rangraj community through education...</p>
          </TabsContent>

          <TabsContent value="members">
            <h2 className="text-2xl font-bold mb-4">Key Members & Trustees</h2>
            <p>Meet the individuals leading our community initiatives...</p>
          </TabsContent>

          <TabsContent value="academy">
            <h2 className="text-2xl font-bold mb-4">Rangrej Academy</h2>
            <p>Rangrej Academy School is a modern educational institution...</p>
          </TabsContent> */}
