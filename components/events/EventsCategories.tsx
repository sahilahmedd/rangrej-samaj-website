  ...
  return (
    ...
    <div className="container px-4 md:px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Link href="#nikah">
          <Card className="h-full hover:border-[#0C2340] transition-colors cursor-pointer">
            <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
              <div className="w-16 h-16 rounded-full bg-rangrez-sand_hover/10 flex items-center justify-center">
        ...
        <Link href="#health">
          <Card className="h-full hover:border-rangrez-indigo_dark transition-colors cursor-pointer">
            <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
              <div className="w-16 h-16 rounded-full bg-rangrez-sand_hover/10 flex items-center justify-center">
